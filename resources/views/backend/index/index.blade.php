...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/index2.html" class="logo">
            ...
            <span class="logo-mini"><b>Y</b>J</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>电商</b>后台</span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/static/backend/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs">Alexander Pierce</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="/static/backend/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="/admin/admin/modifyPassword" target="mainFrame" class="btn btn-default btn-flat">
                                        修改密码
                                    </a>
                                </div>
                                <div class="pull-right">
                                    <a href="/admin/login/layout" target="_top" class="btn btn-default btn-flat">
                                        退出
                                    </a>
                                </div>
                            </li>
...
{{--    {include file="backend/index/menu" /}--}}
    @include('backend.index.menu',['allMenu'=>$allMenu])
    <!-- =============================================== -->
    <style>
        .mainFrame{
            position: absolute;
    ...
    <div class="content-wrapper" style="position: relative">
        <iframe name="mainFrame" src="{{url('backend/mainContent')}}" frameborder="0" class="mainFrame"></iframe>
