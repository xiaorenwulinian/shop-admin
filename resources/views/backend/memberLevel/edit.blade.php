            ...
            <div class="box">
                ...
                <div class="box-body">
                    <form class="form-horizontal" id="formSubmit" action="">
                        <input type="hidden" name="id" value="{{$memberLevelData['id']}}">

                        <div class="form-group">
                            <label for="level_name" class="col-sm-2 control-label">级别名称：</label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="level_name" id="level_name" value="{{$memberLevelData['level_name']}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="bottom_num" class="col-sm-2 control-label">积分下限：</label>
                            <div class="col-sm-3">
                                <input type="number" class="form-control" name="bottom_num" id="bottom_num" value="{{$memberLevelData['bottom_num']}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="number" class="form-control" name="top_num" id="top_num" value="{{$memberLevelData['top_num']}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="rate" class="col-sm-2 control-label">优惠比率(95折，输入95)：</label>
                            <div class="col-sm-3">
                                <input type="number" class="form-control" name="rate" id="rate" value="{{$memberLevelData['rate']}}">
                            </div>
                        </div>
...
<script>
    $(function () {
        ...
        var member_level_id = "<?php echo $memberLevelData['id'];?>";
        $('.curSubmit').on('click',function () {
            ...
            var url = "<?php echo url('backend/memberLevel/editStore');?>";
            $.ajax({
                type: 'post',
                url:  url,
                dataType: 'json',
