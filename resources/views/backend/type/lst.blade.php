...
<section class="content-header">
    <h1>
        商品属性分类列表
        <small> <a href="{{url('backend/type/add')}}" class="pull-right">添加商品属性分类</a></small>
    </h1>
</section>
...
<section class="content">
    <div class="common_search">
        <form class="form-inline" action="{{url('backend/type/lst')}}" id="form_search">
            <input type="text" class="form-control" name="type_name" placeholder="属性分类名称" value="{{request('type_name','')}}">
                ...
                <div class="box-body">
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tr  style="width: 40px;text-align: center">
                            ...
                            <td>{{$v->type_name}}</td>
                            <td>
                                <a href="<?php echo url("backend/type/edit?id={$v->id}"); ?>" title="编辑">编辑</a> |
...
<script>
    $(function () {
        ...
        $('.cur_del').on('click',function () {
            ...
            var url = "<?php echo url('backend/type/delete');?>";
            delete_one(url, id);
        });
        ...
        $('.multi_del').on('click',function () {
            ...
            var url = "<?php echo url('backend/type/multiDelete');?>";
