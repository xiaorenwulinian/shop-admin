...
<section class="content-header">
    <h1>
        商品列表
        <small> <a href="{{url('backend/goods/add')}}" class="pull-right">添加商品</a></small>
    </h1>
</section>
...
<section class="content">
    <div class="common_search">
        <form class="form-inline" action="{{url('backend/brand/lst')}}" id="form_search">
            <input type="text" class="form-control" name="goods_name" placeholder="品牌名称" value="{{request('goods_name','')}}">
...
<script>
    $(function () {
        ...
        $('.cur_del').on('click',function () {
            ...
            var url = "<?php echo url('backend/goods/delete');?>";
            delete_one(url, id);
        });
        ...
        $('.multi_del').on('click',function () {
            ...
            var url = "<?php echo url('backend/goods/multiDelete');?>";
